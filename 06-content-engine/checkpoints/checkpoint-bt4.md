...
| Ảnh GeminiGen chưa xong sau 55s (status vẫn =1) | `Bình thường — nano-banana-pro có lúc cần gần 2 phút. Thêm vòng Wait+poll thứ 2 (đã có sẵn trong file solution), không phải lỗi.` |
...
| Quá giờ | Cấp `checkpoints/app-duyet-solution.html`, học viên chỉ dán 3 URL của mình. |
